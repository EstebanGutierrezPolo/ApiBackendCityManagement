...
CREATE TABLE usuarios (
    ...
    numero_identificacion VARCHAR(20) NOT NULL, -- Número de identificación.
    ...
    UNIQUE (numero_identificacion) -- Restricción: No puede haber el mismo número de documento con el mismo tipo.
);
...
-- ============================================
-- 31. TABLA: representante_legal
-- Contiene todos los representantes legales.
-- ============================================
----- COMPLETADO CSV -----

CREATE TABLE representante_legal (
    id_representante_legal INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE asociaciones (
    id_asociacion SERIAL PRIMARY KEY,         -- Identificador único de la asociación
    nit VARCHAR(14) NULL,                     -- Número de identificación tributaria (puede ser NULL temporalmente)
    nombre_asociacion TEXT NOT NULL,          -- Nombre de la asociación
    id_tipo_asociacion INT NOT NULL,          -- FK al tipo de asociación
    id_representante_legal INT NULL,          -- FK al representante legal (puede ser NULL si no se conoce aún)
    created_at TIMESTAMPTZ DEFAULT NOW(),     -- Fecha de creación
    updated_at TIMESTAMPTZ DEFAULT NOW(),     -- Última actualización

    -- 🔗 Llave foránea al tipo de asociación
    ...
    -- 🔗 Llave foránea al representante legal
    CONSTRAINT fk_asociacion_representante
        FOREIGN KEY (id_representante_legal)
        REFERENCES representante_legal (id_representante_legal)
        ON UPDATE CASCADE
        ON DELETE SET NULL
);
