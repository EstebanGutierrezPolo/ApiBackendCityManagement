...
async function loadBarrios(): Promise<void> {
  const filePath = path.join(__dirname, "../data/barrios.csv");
  ...
  try {
    ...
    if (error instanceof Error) {
      console.error("❌ Error al cargar barrios:", error.message);
    } else {
